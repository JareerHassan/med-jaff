    ...
    return (
        <>
            <div className="header_area  " id="header_contents">
                <header className="header-area header-style-1 htype_three position_absolute bg-white">
                            ...
                            <div className="row align-items-center">
                                ...
                                <div className="col-xl-2 col-lg-3 col-md-7 col-sm-7 col-xs-7 nav_tog_column">
                                    <div className="d-flex right_content align-items-center">
                                        ...
                                        {/*menu icon*/}
                                        <div className="button " style={{border:'3px solid black', borderRadius:'10px'}}>
                                            <Link href="/enrollment" className="theme_btn" style={{color:'black',}}>
                                               Enrollment
